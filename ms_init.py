...
df.to_sql("15m", if_exists='replace', con=conn, index=False)
...
df.to_sql("1h", if_exists='replace', con=conn, index=False)
...
df.to_sql("1d", if_exists='replace', con=conn, index=False)